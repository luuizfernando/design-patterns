 ...
 * Stores QuerySnapshots objects without
...
public class CatalogQueryHistory {
    ...
    private Deque<CatalogQueryState.QuerySnapshot> undoStack = new ArrayDeque<>();
    private Deque<CatalogQueryState.QuerySnapshot> redoStack = new ArrayDeque<>();
    ...
    private void pushBounded(
            Deque<CatalogQueryState.QuerySnapshot> stack,
