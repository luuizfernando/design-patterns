...
public class InProgressState implements TicketState {
    ...
    public void startWork(BugTicket ticket) {
        throw new IllegalStateException(
                "Cannot start work on ticket in " + getStatus() + "state - work is already in progress."
        );
    }

    @Override
    public void close(BugTicket ticket) {
        // Work is completed ... close the ticket
    ...
    public void reopen(BugTicket ticket) {
        throw new IllegalStateException(
                "Cannot reopen ticket in " + getStatus() + "state - only closed ticket can be reopened."
        );
    }
